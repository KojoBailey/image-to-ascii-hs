...
It imports the JuicyPixels `Codec.Picture` module to load images as an array of RGBA values. Therefore, it quite effortlessly supports multiple image formats.
